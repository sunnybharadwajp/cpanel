...
<div class="file-uploader">
    <form on:submit|preventDefault={uploadFile} method="POST" enctype="multipart/form-data" action="/api/files" bind:this={fileForm}>
        <div>
            <div class="field">
                <input type="file" name="file" on:change={handleFileSelect} bind:this={fileInput}>
            </div>
            <div class="field">
